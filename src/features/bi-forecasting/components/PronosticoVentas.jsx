...
const PronosticoVentas = () => {
  const { data, loading, error } = useBIForecasting('ventas');
  ...
  const { kpis, historial, proyeccion, estacionalidad } = data;
    ...
    <div className="flex flex-col gap-6 max-w-[1280px] mx-auto w-full font-display">
      ...
      <div className="flex items-center justify-between mb-2">
        <div>
          <div className="flex items-baseline gap-4 mb-2">
            <h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-slate-100">Detalle de Pronóstico de Ventas</h1>
            <span className="bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 text-xs font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider">Estacional</span>
          </div>
          <p className="text-slate-500 font-medium">Granularidad: <span className="text-slate-700 dark:text-slate-300">MENSUAL</span> | Modelo: <span className="text-slate-700 dark:text-slate-300">Exponential Smoothing</span></p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
          ...
          <p className="text-xs text-slate-400 mt-1">Vs. periodo anterior</p>
        </div>
        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
          <div className="flex justify-between items-start mb-2">
          ...
          <p className="text-xs text-slate-400 mt-1">Intervalo de confianza 95%</p>
        </div>
        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
          <div className="flex justify-between items-start mb-2">
          ...
          <p className="text-xs text-slate-400 mt-1">Promedio mensual de error</p>
        </div>
        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
          <div className="flex justify-between items-start mb-2">
          ...
          <p className="text-xs text-slate-400 mt-1">Bondad de ajuste del modelo</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 mb-4">
        ...
        <div className="lg:col-span-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/50">
            <h3 className="font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
              ...
              Historial Reciente (6 meses)
            </h3>
            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Datos Reales</span>
          </div>
        ...
        <div className="lg:col-span-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-primary/5">
            ...
            <span className="text-xs font-bold text-primary uppercase tracking-widest">IA Model</span>
          </div>
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="bg-slate-50 dark:bg-slate-900/30 text-slate-500 font-semibold border-b border-slate-100 dark:border-slate-700">
                <th className="px-6 py-3">Periodo</th>
                <th className="px-6 py-3 text-right">Venta Proyectada (₲)</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
          ...
          <div className="p-4 bg-slate-50 dark:bg-slate-900/50 text-xs text-slate-500 border-t border-slate-100 dark:border-slate-700 italic">
            * Las proyecciones consideran festividades nacionales y tendencias de consumo histórico.
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden mb-8">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-4">Picos de Demanda</p>
              <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-4">Valles de Demanda</p>
              <div className="flex gap-3">
          ...
          <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-4">Factores Estacionales por Mes</p>
