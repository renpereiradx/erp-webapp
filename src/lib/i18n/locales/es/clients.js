...
export const clients = {
  ...
  'clients.credit.title': 'Cuenta Corriente',
  'clients.credit.loading': 'Cargando cuenta corriente…',
  'clients.credit.collect': 'Registrar cobro a cuenta',
  'clients.credit.amount': 'Monto del cobro',
  'clients.credit.method': 'Método de pago',
  'clients.credit.methodDefault': 'Usar el predeterminado',
  'clients.credit.confirm': 'Registrar cobro',
  'clients.credit.invalidAmount': 'Ingresá un monto válido.',
  'clients.credit.collectError': 'No se pudo registrar el cobro.',
  'clients.credit.collectSuccess': 'Cobro registrado: {allocated} asignados, {unapplied} a favor.',
  'clients.credit.fifoNote': 'El cobro se asigna automáticamente a las ventas más viejas por vencimiento (FIFO).',
  'clients.credit.terms': 'Términos',
  'clients.credit.days': 'días',
  'clients.credit.limit': 'Límite',
  'clients.credit.noLimit': 'sin límite',
  'clients.credit.noDebt': 'Sin deuda pendiente.',
  'clients.credit.unapplied': 'Saldo a favor',
  'clients.credit.openSales': 'ventas abiertas',
  'clients.credit.bucket.current': 'Al día',
  'clients.credit.bucket.1_30': '1-30',
  'clients.credit.bucket.31_60': '31-60',
  'clients.credit.bucket.61_90': '61-90',
  'clients.credit.bucket.over_90': '+90',
