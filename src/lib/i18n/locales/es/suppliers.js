/**
 * Traducciones de proveedores en español
 * Módulo: Gestión de proveedores, órdenes de compra, contactos
 */
...
export const suppliers = {
  ...
  'supplier.subtitle': 'Crea, administra y consulta proveedores clave del negocio.',
  ...
  'supplier.delete.message': 'Esta acción marcará como inactivo al proveedor "{name}".',
  'supplier.reactivate.message': 'Esta acción reactivará al proveedor "{name}".',
