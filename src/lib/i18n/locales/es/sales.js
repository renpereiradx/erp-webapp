...
export const sales = {
  ...
  'sales.checkoutWizard.itemCount': '{count} ítem{count, plural, one {} other {s}}',
  ...
  'sales.checkoutWizard.action.addReservations': 'Añadir {count} reserva{count, plural, one {} other {s}}',
  ...
  'sales.checkoutWizard.client.hasPending': 'Este cliente tiene {count} venta{count, plural, one {} other {s}} pendiente{count, plural, one {} other {s}}.',
  'sales.checkoutWizard.client.hasReservations': 'Este cliente tiene {count} reserva{count, plural, one {} other {s}} confirmada{count, plural, one {} other {s}}.',
