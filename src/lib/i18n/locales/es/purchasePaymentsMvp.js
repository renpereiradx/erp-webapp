...
export const purchasePaymentsMvp = {
  ...
  // ─── Alineación DESIGN.md: página de pagos de compras ─────────────────────
  'purchasePaymentsMvp.page.title': 'Pagos a Proveedores',
  'purchasePaymentsMvp.page.subtitle': 'Gestión de saldos y vencimientos de facturas de compra',
  'purchasePaymentsMvp.actions.report': 'Reporte',
  'purchasePaymentsMvp.actions.viewDetail': 'Ver detalle',
  'purchasePaymentsMvp.actions.cancelOrder': 'Anular orden',
  'purchasePaymentsMvp.actions.back': 'Volver',
  'purchasePaymentsMvp.table.orderDate': 'Orden / Fecha',
  'purchasePaymentsMvp.table.actions': 'Acciones',
  'purchasePaymentsMvp.cancel.fallbackSupplier': 'el proveedor',

  // Toasts y errores de la página
  'purchasePaymentsMvp.toast.loadError': 'No se pudieron cargar las órdenes de pago',
  'purchasePaymentsMvp.toast.refreshing': 'Actualizando listado...',
  'purchasePaymentsMvp.toast.refreshed': 'Listado actualizado',
  'purchasePaymentsMvp.toast.refreshError': 'Error al actualizar el listado',
  'purchasePaymentsMvp.toast.filtersReset': 'Filtros reiniciados',
  'purchasePaymentsMvp.toast.cancelSuccess': 'Orden de compra anulada exitosamente.',
  'purchasePaymentsMvp.toast.cancelError': 'No se pudo anular la orden',
  'purchasePaymentsMvp.toast.paymentSuccess': 'Pago registrado exitosamente',
  'purchasePaymentsMvp.toast.paymentError': 'No se pudo procesar el pago',

  // Página de detalle
  'purchasePaymentsMvp.detail.title': 'Detalle de Compra',
  'purchasePaymentsMvp.detail.loadError': 'No se pudo cargar la orden.',
  'purchasePaymentsMvp.detail.supplierId': 'ID: #{id}',
  'purchasePaymentsMvp.detail.noAddress': 'Sin dirección',
  'purchasePaymentsMvp.detail.currency': 'Moneda',
  'purchasePaymentsMvp.detail.orderTotal': 'Total Orden',
  'purchasePaymentsMvp.detail.products.subtitle': 'Detalle de mercadería recibida',
  'purchasePaymentsMvp.detail.products.count': '{count} Ítems',
  ...
  // Modal de registro: panel de resumen y secciones
  'purchasePaymentsMvp.registerModal.panelTitle': 'Registrar Pago',
  'purchasePaymentsMvp.registerModal.panelSubtitle': 'Proveedor',
  'purchasePaymentsMvp.registerModal.invoiceLabel': 'Factura #{id}',
  'purchasePaymentsMvp.registerModal.percentCovered': '{pct}% cubierto',
  'purchasePaymentsMvp.registerModal.projectedBalance': 'Saldo Proyectado',
  'purchasePaymentsMvp.registerModal.treasuryNote': '* Verifique los datos de tesorería antes de confirmar.',
  'purchasePaymentsMvp.registerModal.section.paymentInfo': 'Información del Pago',
  'purchasePaymentsMvp.registerModal.section.accounting': 'Registro Contable',
  'purchasePaymentsMvp.registerModal.exchangeRate.label': 'Tipo de Cambio',
  'purchasePaymentsMvp.registerModal.originalAmount.label': 'Monto Original ({currency})',
  'purchasePaymentsMvp.registerModal.originalAmount.placeholder': 'Monto en moneda extranjera',
}
