    ...
    (set, get) => ({
          ...
          try {
            ...
            set({
              ...
              totalPages: Math.ceil(
                (response.total || response.count || 0) / currentPageSize,
              ),
              currentPage,
      ...
      createProductPrice: async (productId, priceData) => {
        ...
        try {
          ...
          const response = await productService.createProductPrice(
            productId,
            priceData,
          )
      ...
      updateProductPrice: async (productId, priceData) => {
        ...
        try {
          productService.validatePriceData(priceData)
          const response = await productService.updateProductPriceByProductId(
            productId,
            priceData,
          )
      ...
      createStock: async (productId, stockData) => {
        ...
        try {
          ...
          const response = await productService.createStock(
            productId,
            stockData,
          )
      ...
      getLowStockProducts: async (threshold = 10) => {
        ...
        return state.products.filter(
          product => product.stock && product.stock < threshold,
        )
      },
