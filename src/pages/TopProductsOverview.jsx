                  ...
                  <tr key={product.id} className="group hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-4">
                        <div className="h-12 w-12 rounded-xl bg-surface-muted flex items-center justify-center text-on-surface-deep border border-border-subtle shrink-0 group-hover:scale-110 transition-transform shadow-sm">
                        ...
                        <div className="flex flex-col gap-0.5">
                          ...
                          {product.brand_name && (
                            <span className="text-[9px] text-slate-600 dark:text-on-surface-deep font-semibold bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded w-fit mt-0.5">
                              {product.brand_name}
                            </span>
                          )}
