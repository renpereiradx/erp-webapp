    ...
    const fetchData = async () => {
      ...
      try {
        const [compRes, trendsA, trendsB] = await Promise.all([
          ...
          salesAnalyticsService.getTrends({ period: 'month', granularity: 'daily' }), // Simplifying for demo
          salesAnalyticsService.getTrends({ period: 'year', granularity: 'monthly' }) // Different period for visual diff
        ]);
