          ...
          <section className="bg-white dark:bg-[#1b2633] border border-[#edebe9] dark:border-[#2d3d4f] shadow-sm rounded-2xl overflow-hidden">
            ...
            <div className="p-6">
              <div className="flex items-start gap-4 mb-6">
                <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center text-primary shrink-0 shadow-sm border border-primary/10">
                  <Store size={28} />
                </div>
                <div className="flex-1 min-w-0">
                ...
                {invoice.actividad.length > 0 ? invoice.actividad.map((act, idx) => {
                  ...
                  return (
                    <div key={idx} className="flex gap-4 group cursor-default">
                      <div className={`relative z-10 w-6 h-6 rounded-full flex items-center justify-center shrink-0 shadow-sm ${iconBg} ring-4 ring-white dark:ring-surface-dark transition-transform`}>
