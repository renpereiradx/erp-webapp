      ...
      <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div className="flex flex-col gap-1 border-l-4 border-primary pl-4">
          <div className="flex items-center gap-3">
            <h1 className="text-headline-lg text-foreground leading-none mb-1">{t('users.title')}</h1>
          ...
          <p className="text-body-md text-on-surface-deep">Administra accesos, roles y seguridad de la plataforma.</p>
        </div>
