...
const NewCashRegister = () => {
  ...
  const calculateDifference = () => {
    ...
    const currentBalance = activeCashRegister.current_balance || 0;
    ...
    <div className="new-cash-register-page">
      ...
      <div className="new-cash-register-page__header">
        ...
        <p className="new-cash-register-page__subtitle">
          {t('cashRegister.subtitle', 'Abre o cierra una caja para registrar los movimientos de efectivo.')}
        </p>
      </div>
      ...
      <div className="new-cash-register-page__tabs">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <div className="new-cash-register-page__tabs-list">
            <button
              ...
              className={`new-cash-register-page__tab-trigger ${
                activeTab === 'open' ? 'new-cash-register-page__tab-trigger--active' : ''
              }`}
            >
            ...
            <button
              ...
              className={`new-cash-register-page__tab-trigger ${
                activeTab === 'close' ? 'new-cash-register-page__tab-trigger--active' : ''
              }`}
            >
          ...
          <TabsContent value="open" className="new-cash-register-page__tab-content">
            <form onSubmit={handleOpenSubmit} className="new-cash-register-page__form">
              {/* Cash Register Name */}
              <div className="new-cash-register-page__form-field">
                <label htmlFor="open-name" className="new-cash-register-page__form-label">
              ...
              {/* Location (optional) */}
              <div className="new-cash-register-page__form-field">
                <label htmlFor="open-location" className="new-cash-register-page__form-label">
              ...
              {/* Opening Date */}
              <div className="new-cash-register-page__form-field">
                <label htmlFor="open-date" className="new-cash-register-page__form-label">
              ...
              {/* Initial Balance */}
              <div className="new-cash-register-page__form-field">
                <label htmlFor="open-balance" className="new-cash-register-page__form-label">
                ...
                <div className="new-cash-register-page__form-input-wrapper">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleOpenFormChange('initialBalance', e.target.value)}
                    placeholder={t('cashRegister.open.initialBalance.placeholder', '0.00')}
              ...
              <div className="new-cash-register-page__form-field new-cash-register-page__form-field--full">
                <label htmlFor="open-notes" className="new-cash-register-page__form-label">
              ...
              {formError && activeTab === 'open' && (
                <div className="new-cash-register-page__form-field new-cash-register-page__form-field--full">
                  <div style={{ padding: '12px', backgroundColor: 'rgba(239, 68, 68, 0.1)', border: '1px solid rgba(239, 68, 68, 0.3)', borderRadius: '6px' }}>
                    <p style={{ fontSize: '14px', color: '#dc2626' }}>{formError}</p>
                  </div>
                </div>
              )}
          ...
          <TabsContent value="close" className="new-cash-register-page__tab-content">
            {activeCashRegister ? (
              <>
                <form onSubmit={handleCloseSubmit} className="new-cash-register-page__form">
                  {/* Cashier (read-only) */}
                  <div className="new-cash-register-page__form-field">
                    <label htmlFor="close-cashier" className="new-cash-register-page__form-label">
                  ...
                  {/* Register (read-only) */}
                  <div className="new-cash-register-page__form-field">
                    <label htmlFor="close-register" className="new-cash-register-page__form-label">
                  ...
                  {/* Closing Date */}
                  <div className="new-cash-register-page__form-field">
                    <label htmlFor="close-date" className="new-cash-register-page__form-label">
                  ...
                  {/* Final Balance */}
                  <div className="new-cash-register-page__form-field">
                    <label htmlFor="close-balance" className="new-cash-register-page__form-label">
                    ...
                    <div className="new-cash-register-page__form-input-wrapper">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleCloseFormChange('finalBalance', e.target.value)}
                    ...
                    <p style={{ fontSize: '14px', marginTop: '4px', color: 'var(--text-secondary)' }}>
                      {t('cashRegister.close.systemBalance', 'Saldo del Sistema')}: ₲{activeCashRegister.current_balance || 0}
                    </p>
                    {closeForm.finalBalance && (
                      <p style={{ fontSize: '14px', marginTop: '4px', fontWeight: 600, color: calculateDifference() >= 0 ? '#10b981' : '#ef4444' }}>
                        {t('cashRegister.close.difference', 'Diferencia')}: ₲{calculateDifference().toFixed(2)}
                      </p>
                    )}
                  </div>
                  ...
                  {/* Closing Notes */}
                  <div className="new-cash-register-page__form-field new-cash-register-page__form-field--full">
                    <label htmlFor="close-notes" className="new-cash-register-page__form-label">
              ...
              <DataState
                ...
                description={t('cashRegister.empty.message', 'No hay cajas registradas. Abre una nueva caja para comenzar.')}
              />
            )}
          </TabsContent>
        </Tabs>
