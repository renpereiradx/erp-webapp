      ...
      <div className='flex flex-col md:flex-row md:items-center justify-between gap-6'>
        <div className='flex flex-col gap-3'>
          <button 
            ...
            className='flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-on-surface-variant hover:text-primary transition-colors w-fit'
          >
          ...
          <Card className='border-none rounded-3xl shadow-fluent-2 bg-white dark:bg-slate-900 overflow-hidden'>
            <CardContent className='p-10 space-y-10'>
              <div className='space-y-4'>
                <Label className="text-[10px] font-black uppercase tracking-[0.3em] text-on-surface-variant ml-1">Clase de Transacción</Label>
                <SegmentedControl
                  options={[
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
                <div className='space-y-4'>
                  <Label className="text-[10px] font-black uppercase tracking-[0.3em] text-on-surface-variant ml-1">Concepto Operativo</Label>
                  <div className='relative group'>
                    ...
                    <ChevronRight className='absolute right-4 top-1/2 -translate-y-1/2 text-on-surface-variant rotate-90 pointer-events-none group-hover:text-primary transition-colors w-5 h-5' />
                  </div>
                </div>

                <div className='space-y-4'>
                  <Label className="text-[10px] font-black uppercase tracking-[0.3em] text-on-surface-variant ml-1">Monto de la Operación</Label>
                  <div className='relative'>
                    <span className='absolute inset-y-0 left-0 pl-5 flex items-center text-on-surface-variant font-black text-xl'>₲</span>
                    <Input
                      type='number'
              ...
              <div className='space-y-4'>
                <Label className="text-[10px] font-black uppercase tracking-[0.3em] text-on-surface-variant ml-1">Memoria / Observaciones (Opcional)</Label>
                <Textarea
          ...
          <Card className='border-none rounded-3xl shadow-fluent-2 bg-white dark:bg-slate-900 overflow-hidden'>
            ...
            <CardContent className='p-8 space-y-6'>
              <div className='flex items-start gap-4'>
                <div className='size-8 rounded-full bg-surface-container-low flex items-center justify-center text-on-surface-variant shrink-0'><CheckCircle2 className='w-4 h-4' /></div>
                <div>
              ...
              <div className='flex items-start gap-4'>
                <div className='size-8 rounded-full bg-surface-container-low flex items-center justify-center text-on-surface-variant shrink-0'><Settings className='w-4 h-4' /></div>
                <div>
