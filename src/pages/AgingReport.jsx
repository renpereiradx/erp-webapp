    ...
    <div className="bg-[#f6f7f8] dark:bg-[#101922] font-['Inter',_sans-serif] text-slate-900 dark:text-slate-100 min-h-screen selection:bg-blue-100 selection:text-blue-900 pb-12">
        ...
        <div className="max-w-[2560px] mx-auto flex flex-col lg:flex-row gap-4 lg:gap-0 lg:justify-between lg:items-center">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-2">
              <span className="material-icons-round text-[#137fec] text-2xl md:text-3xl">account_balance_wallet</span>
              <h1 className="text-lg md:text-xl font-bold tracking-tight">Reporte de Antigüedad</h1>
            </div>
            <div className="hidden sm:block h-6 w-px bg-slate-300 dark:bg-slate-700"></div>
            <div className="flex items-center gap-2 sm:block">
              <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-semibold tracking-wider leading-none">Corte al:</p>
              <p className="text-xs md:text-sm font-medium">{summary.lastUpdate}</p>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-2 md:gap-3">
            <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 md:px-4 py-2 text-xs md:text-sm font-medium border border-slate-200 dark:border-slate-700 rounded bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
              <span className="material-icons-round text-sm">filter_list</span> <span className="hidden sm:inline">Filtrar</span>
            </button>
            <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 md:px-4 py-2 text-xs md:text-sm font-medium border border-slate-200 dark:border-slate-700 rounded bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
              <span className="material-icons-round text-sm">file_download</span> <span className="hidden sm:inline">Exportar</span>
            </button>
      ...
      <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 flex flex-col gap-3 z-50">
        <button className="w-10 h-10 md:w-12 md:h-12 bg-white dark:bg-slate-800 shadow-xl border border-slate-200 dark:border-slate-700 rounded-full flex items-center justify-center text-slate-600 dark:text-slate-300 hover:bg-slate-50 transition-all">
          <span className="material-icons-round text-sm md:text-base">help_outline</span>
        </button>
        <button className="w-10 h-10 md:w-12 md:h-12 bg-[#137fec] text-white shadow-xl rounded-full flex items-center justify-center hover:scale-105 transition-all">
          <span className="material-icons-round text-sm md:text-base">chat_bubble_outline</span>
        </button>
      </div>
    </div>
  );
