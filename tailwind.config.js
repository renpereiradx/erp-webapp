...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        /* @tokens:color:start */
        primary: {"DEFAULT":"#005baf","hover":"#0074db","foreground":"hsl(var(--primary-foreground))"},
        secondary: {"DEFAULT":"#455f89","foreground":"hsl(var(--secondary-foreground))"},
        ...
        surface: "#f8f9ff",
        text: {"main":"hsl(var(--text-main))","secondary":"hsl(var(--text-secondary))"},
      ...
      borderRadius: {
        ...
        lg: "16px",
        xl: "24px",
        /* @tokens:borderRadius:end */
      },
      boxShadow: {
        /* @tokens:boxShadow:start */
        ...
        /* @tokens:boxShadow:end */
      },
      fontSize: {
        /* @tokens:fontSize:start */
