...
Los endpoints de lectura (`GET`) están disponibles para todos los usuarios autenticados. Los usuarios ADMIN ven todas las sucursales sin restricción; los no-ADMIN ven solo sus sucursales en `allowed_branches` del JWT.
