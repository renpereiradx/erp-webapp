...
> **[Variant-Aware BI](VARIANT_AWARE_BI.md)** — Documentación de integridad de
> datos con variantes, multi-sucursal (scope consolidado vs sucursal), nuevas
> dimensiones (marca/etiquetas) y COGS por variante. Lectura obligatoria si se
> modifican queries BI o se consumen los endpoints.
