...
```bash
curl -X GET "http://localhost:5050/payables/overview" \
...
```bash
curl -X GET "http://localhost:5050/payables/schedule?days=15" \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json"
```
...
```bash
curl -X GET "http://localhost:5050/payables/payment-capacity?days=30" \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json"
```
...
```bash
curl -X GET "http://localhost:5050/payables/cash-flow?days=60" \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json"
```
